                        ...
                        <nav class="navbar navbar-default" id="mainNav">
                            ...
                            <div id="navbar" class="navbar-collapse collapse">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a href="#reservation">Contacto</a></li>
                                </ul>
                            </div>
                            <!-- end nav-collapse -->
                        </nav>
                ...
                <div class="banner-static">
                    <div class="banner-text">
                        <div class="banner-cell">
                            <h1>Disfrutá de nuestras  <span class="typer" id="some-id" data-delay="200" data-delim=":" data-words="Bebidas:Comidas:" data-colors="red"></span><span class="cursor" data-cursorDisplay="_" data-owner="some-id"></span></h1>
                            <h2>Probá la experiencia Chill Beer </h2>
                            <p>Los mejores tragos, las mejores comidas y los mejores postres</p>
                            <div class="book-btn">
                                <a href="#reservation" class="table-btn hvr-underline-from-center">Conocé más</a>
                            </div>
                            <a href="#about">
                                <div class="mouse"></div>
                            </a>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        ...
                        <h3>EXPERIMENTÁ UNA NUEVA CLASE DE PATIO CERVECERO...</h3>
    ...
    <div class="special-menu pad-top-100 parallax">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <h2 class="block-title color-white text-center"> Recomendación de la semana </h2>
                        <h5 class="title-caption text-center"> Estas fueron algunas de las cosas que más se pidieron la semana pasada, y que pensamos que podrían llegar a gustarte a vos también. </h5>
                    </div>
                    ...
                    <div class="team-box">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6">
                                <div class="sf-team">
                                    <div class="thumb">
                                        <a href="#"><img src="assets/images/staff-01.jpg" alt=""></a>
                                    </div>
                                    <div class="text-col">
                                        <h3>John Doggett</h3>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="sf-team">
                                    <div class="thumb">
                                        <a href="#"><img src="assets/images/staff-02.jpg" alt=""></a>
                                    </div>
                                    <div class="text-col">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="sf-team">
                                    <div class="thumb">
                                        <a href="#"><img src="assets/images/staff-03.jpg" alt=""></a>
                                    </div>
                                    <div class="text-col">
                                        <h3>Monica Reyes</h3>
                                        <p>Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales sagittis magna. Aenean commodo ligula.</p>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        ...
                        <p class="title-caption text-center">Estas son algunas de las opciones que tenemo para ofrecerte </p>
                    </div>
    ...
    <div class="footer-news pad-top-100 pad-bottom-70 parallax">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <h2 class="block-title text-center"> Comunidad </h2>
                        <p> Dejanos tu instagram o tu facebook y te seguimos para que no te pierdas de nada</p>
                    </div>
                    <form>
                        <input type="email" placeholder="Ingresá tu instagram o Facebook">
            ...
            <div class="row">
                <div class="form-reservations-box">
					...
					Contacto			
                        ...
                        <h4 class="form-title">HACENOS TU PREGUNTA</h4>
                        <p>TE RESPONDEMOS AL INSTANTE!</p>
                        ...
                        <form id="contact-form" method="post" class="reservations-box" name="contactform" action="mail.php">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="reserve-book-btn text-center">
                                    <button class="hvr-underline-from-center" type="submit" value="SEND" id="submit">PREGUNTAR </button>
                                </div>
                            </div>
                            <!-- end col -->
                        </form>
                    ...
                    <div class="footer-in-main">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box-a">
                                <h3>Nosotros</h3>
                                <p>En Chill Beer no enorgullecemos de poder decir que somos el mejor patio cervecero de todo Mar de Ajó.</p>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box-b">
                                <h3>Vendemos</h3>
                                <ul>
                                    <li><a href="#">Bebidas con y sin alcohol</a></li>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box-c">
                                ...
                                <p>
                                    ...
                                    <span>Hipólito Yrigoyen 216, Mar de Ajó, Buenos Aires</span>
                                </p>
                                <p>
                                ...
                                <p>
                                    ...
                                    <span><a href="#">chillbeer@info.com</a></span>
                                </p>
                            </div>
                            <!-- end footer-box-c -->
                        </div>
