        ...
        @method('PUT')
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                <div class="grid grid-cols-1">
                    ...
                    <input value="{{old('nombre') ?? $producto->nombre}}" name="nombre" class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"  type="text" required/>
                </div>
                <div class="grid grid-cols-1">
                    <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Descripción:</label>
                    <input value="{{old('descripcion') ?? $producto->descripcion}}" name="descripcion" class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"  type="text" required/>
                </div>
                <div class="grid grid-cols-1">
                    <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Precio:</label>
                    <input name="precio" value="{{old('precio') ?? $producto->precio}}" class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="number" required/>
                </div>
                <div class="grid grid-cols-1">
                    ...
                    <option value="{{old('categoria' ?? $producto->categoria)}}"></option>
            ...
            <div class="grid grid-cols-1 mt-5 mx-7">
                <img src="/imagenP/{{ $producto->imagen }}" style="max-height: 300px;">           
            </div>
            <div class="grid grid-cols-1 mt-5 mx-7">
