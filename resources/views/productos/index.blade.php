                    ...
                    <tbody>
                        @foreach ($productos as $producto)
                            <tr>
                                ...
                                <td class="border text-center" style="max-width: 150px">{{ $producto->nombre }}</td>
                              ...
                              width: 100%;">{{ $producto->descripcion }}</textarea>
                                ...
                                <td class="border px-14 py-1">
                                    <img style="display: block; margin:0 auto;" src="/imagenP/{{ $producto->imagen }}"
                                        width="100px" height="100px">
                                </td>
                                <td class="border text-center" style="max-width: 150px">{{ $producto->precio }}</td>
                                <td class="border text-center" style="max-width: 150px">{{ $producto->categoria }}</td>
